<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransactionsADOWebForm.aspx.cs" Inherits="ADODOTNET_Concepts_WebApplication.TransactionsADOWebForm" %>
...
<body>
    <form id="form1" runat="server">
        <div style="font-family: Arial">
            <table border="1" style="background-color: lightcoral; color: white">
                <tr>
                    <td>
                        <b>Account Number </b>
                    </td>
